...
- Clean messy CSV/Excel data (types, missing values, duplicates, odd strings)
- Run focused exploratory data analysis to surface quick insights
...
- `01 – Clean Dataset`: A lightweight example showing how we standardise a customer list (countries, newsletter flags, unrealistic ages, duplicates) and export a ready-to-use file.
- `02 – Clean + Insight Pack`: A fuller walkthrough that combines sales-data cleaning, revenue-focused EDA with matplotlib charts, and a concise report aimed at business stakeholders.
